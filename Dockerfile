...
RUN wget https://cmake.org/files/v3.8/cmake-3.8.2-Linux-x86_64.tar.gz && tar -xzf cmake-3.8.2-Linux-x86_64.tar.gz -C /var/opt && rm cmake-3.8.2-Linux-x86_64.tar.gz
