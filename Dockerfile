...
SHELL ["/bin/bash", "-lc"]
RUN pacman -Syu --noconfirm && pacman -S --noconfirm wget git openssh tar gzip unzip ca-certificates base-devel gradle gcc clang cmake sfml python xorg xorg-server xorg-apps xorg-server-xvfb
