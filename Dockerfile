...
RUN wget https://cmake.org/files/v3.11/cmake-3.11.4-Linux-x86_64.tar.gz && tar -xzf cmake-3.11.4-Linux-x86_64.tar.gz -C /var/opt && rm cmake-3.11.4-Linux-x86_64.tar.gz
